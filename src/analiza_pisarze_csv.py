...
from pisarze import rule_patterns
...
if __name__ == "__main__":
    ...
    for nr in range(1, 13):
        ...
        matcher.add("Pisarze", patterns=patterns)

        lista = []

        input_path = Path('.').parent / f'output/data{nr}hasla.csv'
        output_path = Path('.').parent / f'output/pisarze_{slowniki[nr]}.txt'
        text_path = Path('.').parent / f'output/pisarze_text_{slowniki[nr]}.txt'
